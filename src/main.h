...
static const int64 DUST_SOFT_LIMIT = 1000000; // 0.01 MED
/** Dust Hard Limit, ignored as wallet inputs (mininput default) */
static const int64 DUST_HARD_LIMIT = 100000;   // 0.001 MED mininput
/** No amount larger than this (in satoshi) is valid */
static const int64 MAX_MONEY = 935040000 * COIN;
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 16000 / 250;
    }
